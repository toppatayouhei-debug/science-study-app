...
if sub == "選択してください":
    ...
    <div class="concept-section">
        ...
        <p>
            数Ⅲ微積の「基本」を即答レベルへ。<br>
            入試問題と戦うための「武器（定石）」を完璧に使いこなす。
        </p>
        <div class="section-title">⚡ Strategy</div>
        <p>
            <b>① 基本の即答化</b>：入試の合否を分ける「基本問題」を、迷わず解けるまで繰り返す。<br>
            <b>② 瞬発力の養成</b>：形を見た瞬間に、正しい解法が思い浮かぶ「反射神経」を鍛える。<br>
            <b>③ 型（パターン）の習得</b>：解き方の「型」の習得が目標です。計算の迷いをゼロにします。
        </p>
        <div style="margin-top:20px; font-size: 0.95rem; color: #666;">
            ※数学の演習には紙とペンは不要です。頭の中で解法のプロセスをイメージしてください。
        </div>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
...
if sub == "システム英単語":
    ...
    task = "この式の「型」を見抜け（微分）：" if is_diff else "この式の「型」を見抜け（不定積分）："
    ...
    if not st.session_state.answered:
        st.info("💡 頭の中で解法をイメージしてから解答を確認してください。")
